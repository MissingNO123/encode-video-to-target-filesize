...
argparser.add_argument('-vw', '--width', type=int, help='Scale to this Width')
argparser.add_argument('-vh', '--height', type=int, help='Scale to this Height')
argparser.add_argument('-f', '--fps', type=int, help='Target frame rate', default=30)
argparser.add_argument('-i', '--in-point', type=str, help='Trim start time in HH:MM:SS format')
argparser.add_argument('-o', '--out-point', type=str, help='Trim end time in HH:MM:SS format')
argparser.add_argument('-cv', '--video-codec', type=str, help='Override the video codec to use', default='libx264')
argparser.add_argument('-ca', '--audio-codec', type=str, help='Override the audio codec to use', default='libopus')
argparser.add_argument('-ba', '--audio-bitrate', type=int, help='Target audio bitrate in kbps', default=96)
argparser.add_argument('-m', '--merge-audio', action='store_true', help='Merge all audio tracks into one (by default only first audio track is used)')
argparser.add_argument('-at', '--audio-tracks', type=str, help='A list of which specific audio tracks to merge, comma separated (e.g. "0,2")')
argparser.add_argument('--audio-track-name', type=str, help='Name for the final merged audio track', default='Why are you looking at this?')
